                        ...
                        <div className="modal-dialog modal-dialog-centered">
                            <div className={`modal-content bg-${theme.color}`}>
                                ...
                                <div className="modal-footer d-flex justify-content-center">
                                    <button type="button" className={`btn btn-${(theme.text === 'white' ? 'light' : 'dark')} px-4`} onClick={() => { dispatch(deleteBill(delete_Bill_Id)); navigate("/home"); }} data-bs-dismiss="modal">YES</button>
